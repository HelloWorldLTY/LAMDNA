...
class LightningModel(pl.LightningModule):
    ...
    def __init__(
        ...
        # The LLM is used only as a frozen instruction encoder (excluded from
        # configure_optimizers). Freeze it and keep it in eval mode so no
        # gradients are built through the language model.
