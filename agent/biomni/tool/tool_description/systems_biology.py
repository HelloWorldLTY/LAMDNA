description = [
    ...
    {
        "description": "Create DNA sequences as enhancers or promoters ",
        "name": "create_dna_sequence",
        "optional_parameters": [
            {
                "default": -1,
                "description": "Device to use for the ChatNT model. Default is -1 (CPU).",
        ...
        "required_parameters": [
            {"default": "A", "description": "Requirement of DNA sequence design", "name": "question", "type": "str"},
        ],
    },
]
